        ...
        if (this.cameraFollow && this.player && this.player.mesh) {
            ...
            if (this.lockedEnemy && this.lockedEnemy.mesh) {
                ...
                try {
                    ...
                    this.camera.position = BABYLON.Vector3.Lerp(this.camera.position, desiredPos, this._cameraPosLerp);
